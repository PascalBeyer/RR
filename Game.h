...
{	
	...
	
   {
      ...
      PushAnimatedMeshImmidiet(rg, mesh, {1, 0, 0, 0}, V3(), 1.0f, V4(1.0f, 0.4f, 1.0f, 1.0f), boneStates);
      
      PushAnimatedMesh(rg, mesh, {1, 0, 0, 0}, V3(1, 0, 0), 1.0f, V4(1.0f, 0.4f, 1.0f, 1.0f), boneStates);
   }
